...
export default function CountryDetailView({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Konsultatsiya CTA (faqat public tomon) */}
            {showConsultation && (
              <div
                style={{
                  background: "linear-gradient(135deg, #89aac3, #6f93b0)",
                  borderRadius: "16px",
                  padding: "24px",
                  color: "#FFF",
                }}
      ...
      {/* Mobil: sidebar pastga tushsin (dizayn buzilmasin) */}
      <style>{`
        @media (max-width: 860px) {
          .country-detail-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
